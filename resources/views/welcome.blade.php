...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{asset('depan/css/styles-merged.css')}}">
    <link rel="stylesheet" href="{{asset('depan/css/style.min.css')}}">
  ...
  <body>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <div class="row">
              <div class="col-md-12">
                <p><img src="{{asset('depan/img/laptop_1.jpg')}}" alt="Free Template by uicookies.com" class="img-responsive"></p>
              </div>
            </div>
            <div class="row">
              <div class="col-md-6">
    ...
    <script src="{{asset('depan/js/scripts.min.js')}}"></script>
