...
<body>
    ...
    <hr style="margin-top:1px;">
        <div class="isi">
            <h2 style="text-align:center; text-decoration:underline;margin:0px;">SURAT IZIN PRAKTIK</h2>
            <h5 style="text-align:center; text-decoration:underline; margin:10px;">Nomor: 445/&nbsp;/DPMPTSP/SIP-{{Carbon\carbon::parse($data->created_at)->format('Y')}}</h5>
            <br>
            <p style="text-align: justify;">Berdasarkan Peraturan Menteri Kesehatan Republik Indonesia Nomor 2052/Menkes/Per/X/2011 tentang Izin Praktik dan Pelaksanaan Praktik Kedokteran, yang bertandatangan dibawah ini, Kepala Dinas Penanaman Modal dan Pelayanan Terpadu Satu Pintu Kabupaten Banjar memberikan Izin Praktik Dokter kepada:</p>
            ...
            <p style="padding-left: 100px;">Dengan kewenangan klinis sesuai dengan kompetensinya.</p>
            <br>
            <br>
            <table>
                <tr>
            ...
            <table>
                <tr>
                    <td style="text-align: right; width:60%"><img src="lampiran/foto/{{$data->lampiran->foto}}" alt=""></td>
