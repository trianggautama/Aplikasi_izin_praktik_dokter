                ...
                <div class="card-body">
                    <form action="{{Route('pemohon.permohonan.store')}}" enctype="multipart/form-data" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md">
                                <div class="form-group">
                                    <label for="">Surat Penytanaan Pelaporan Psikotropika dan Narkotika & Pertisipasi (APJs)</label>
                        ...
                        <div class="text-right">
                            <a href="{{Route('pemohon.permohonan_apoteker.index')}}" class="btn btn-secondary"
