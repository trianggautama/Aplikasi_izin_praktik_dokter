    ...
    <div class="row">
        <div class="col-12 grid-margin">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{Route('pemohon.permohonan_farmasi.update',$data->id)}}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="praktik_ke" value="{{$data->praktik_ke}}" class="form-control"
                                required>
                        </div>
                        <!-- <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="surat_rekomendasi_pafi" class="form-control">
                                </div>
                            </div>
                            <div class="col-md">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="surat_izin_tempat_kerja" class="form-control">
                                </div>
                            </div>
                            <div class="col-md">
                                <div class="form-group">
