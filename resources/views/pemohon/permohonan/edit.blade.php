    ...
    <div class="row">
        <div class="col-12 grid-margin">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{Route('pemohon.permohonan.update',$data->id)}}" enctype="multipart/form-data"
                        method="post">
                        @method('put')
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nomor_str" value="{{$data->nomor_str}}"
                                        class="form-control" required>
                                </div>
                            </div>
                            <div class="col-md">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nomor_rekomendasi" value="{{$data->nomor_rekomendasi}}"
                                        class="form-control" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <input type="text" name="tempat_praktik" value="{{$data->tempat_praktik}}"
                                class="form-control" required>
                        </div>
                        <div class="form-group">
                            <label for="">Alamat Praktik</label>
                            <textarea name="alamat_tujuan" id="" class="form-control"
                                required>{{$data->alamat_tujuan}}</textarea>
                        </div>
                        <!-- <div class="form-group">
