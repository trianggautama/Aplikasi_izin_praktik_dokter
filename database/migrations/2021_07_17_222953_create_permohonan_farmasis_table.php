...
class CreatePermohonanFarmasisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('permohonan_farmasis', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('permohonan_farmasis');
    }
}
